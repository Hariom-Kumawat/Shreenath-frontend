...
import AddHolidayModal from "../../../components/Modals/Admin/AddHoliday";
import DeleteHoliday from "../../../components/Modals/Admin/DeleteHoliday";
...
export default function Holidays() {
    ...
    return (
        <>
                ...
                <div className="content">
                    <div className="content-head mb-5 d-flex align-items-start justify-content-between">
                        ...
                        <div className="d-flex align-items-center gap-3">
                            <Link to="" onClick={toggleModal} data-bs-toggle="modal" role="button" className="btn btn-outline-primary px-5">
                                <span>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-end">
                                                    <div className="d-flex align-items-center justify-content-end gap-3">
                                                        <button onClick={toggleDeleteModal} className="btn  border-0 text-danger bg-danger-subtle py-2" type="button"
            ...
            {openModal && (<AddHolidayModal openModal={openModal} toggleModal={toggleModal}/> )}

            {deleteModal && (<div className="modal-backdrop fade show"></div>)}
            {deleteModal && ( <DeleteHoliday deleteModal={deleteModal} toggleDeleteModal={toggleDeleteModal} /> )}
        </>
    )
}