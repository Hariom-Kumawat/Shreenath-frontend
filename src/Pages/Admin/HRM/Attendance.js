                        ...
                        <div className="card-body">
                            <div class="wizard-tabs">
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        {/* <button className={attendance === 'monthly' ? "nav-link avtive" : "nav-link"} onClick={toggleMonthlyAttendance} id="pills-MonthlyAttendance-tab" data-bs-toggle="pill" data-bs-target="#pills-MonthlyAttendance" type="button" role="tab" aria-controls="pills-MonthlyAttendance" aria-selected="true">
                                            <h5></h5>
                                        </button> */}
