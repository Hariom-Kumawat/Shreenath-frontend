            ...
            <div className="main-view-content" id="contentWrapper">
                <div className="content">
                    <div className="content-head mb-5 d-flex align-items-start justify-content-between">
                        <h1 className="mb-0">Item Master</h1>
                        <div className="d-flex align-items-center gap-3">
                            <a href="#additemModal" data-bs-toggle="modal" className="btn btn-outline-primary px-5">
                                <span>
                        ...
                        <div className="card-body">
                            <nav>
                                <div className="nav nav-tabs  border-0 " id="nav-tab" role="tablist">
                                    <button className="btn btn-outline-primary active px-5 rounded-0 rounded-start-2" id="nav-home-tab"
                                        data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="nav-home"
                                        aria-selected="true">Item</button>
                                    <button className="btn btn-outline-primary px-5 rounded-0 rounded-end-2" id="nav-profile-tab"
                            ...
                            <div className="tab-content mt-4" id="nav-tabContent">
                                    ...
                                    <div className="manage-table main-table table-responsive">
                                        <table className="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>01</td>
                                                    <td>Silicone Sealent</td>
                                                    <td> O&M Assets</td>
                                                    <td>Nos.</td>
                                                    <td>
                                                        <div className="form-check form-group p-0 d-inline-block">
                                ...
                                <div className="tab-pane fade" id="tab-two" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                                    <div className="table-head mb-4 border-bottom pb-3">
