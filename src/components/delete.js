...
//                     <li>handleClickOutside
//                         <span className="menu-title"> Menu </span>
//                     </li>
//                     <li>
//                         <Link to={RoutesLink?.dashboard_route}
//                             onClick={() => toggleIsActive('dashboard')} className={isActive === 'dashboard' ? "drop-link active" : "drop-link "}
//                             role="button">
//                             <svg
...
//                     <li>
//                         {!barIconClicked && (<Link className="drop-link btn-menu" onClick={toggleSites} role="button">
//                             <span className="menu-title border-0 p-0 m-0"> Sites </span>
//                             <svg
//                                 className={sites ? "chevron ms-auto dropdown rotate" : "chevron ms-auto dropdown"}
//                                 xmlns="http://www.w3.org/2000/svg"
//                                 width="20"
//                                 height="20"
//                                 viewBox="0 0 20 20"
...
//                         </Link>
//                         )}
//                         <ul className="sub-menu" style={{ display: sites ? 'block' : 'none' && barIconClicked ? "block" : 'none' }}  >
//                             <li>
//                                 <Link
//                                     to={RoutesLink?.sites_route}
//                                     onClick={() => toggleIsActive('sites')}
//                                     className={isActive === 'sites' ? 'drop-link active' : 'drop-link'}
//                                     role="button"
//                                 >
//                                     <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="18" x="0" y="0" viewBox="0 0 64 64" style={{ enableBackground: "new 0 0 512 512" }} ><g><path d="M18.179 39.571A1.002 1.002 0 0 0 19 40h.01a1 1 0 0 0 .822-.445c.893-1.34 1.872-2.702 2.91-4.145C27.081 29.37 32 22.525 32 15a13 13 0 0 0-26 0c0 8.019 4.766 14.466 9.375 20.702.94 1.272 1.913 2.588 2.804 3.87ZM19 4a11.012 11.012 0 0 1 11 11c0 6.881-4.72 13.448-8.883 19.243a206.218 206.218 0 0 0-2.133 3.003c-.659-.917-1.338-1.836-2-2.733C12.565 28.538 8 22.36 8 15A11.012 11.012 0 0 1 19 4Z" fill="#000000" opacity="1" data-original="#000000"></path><path d="M27 15a8 8 0 1 0-8 8 8.01 8.01 0 0 0 8-8Zm-14 0a6 6 0 1 1 6 6 6.007 6.007 0 0 1-6-6ZM2 62h60a1 1 0 0 0 .98-1.196l-5-25A1 1 0 0 0 57 35h-4v2h3.18l4.6 23H3.22l4.6-23H13v-2H7a1 1 0 0 0-.98.804l-5 25A1 1 0 0 0 2 62ZM39 33a5 5 0 1 0-5-5 5.006 5.006 0 0 0 5 5Zm0-8a3 3 0 1 1-3 3 3.003 3.003 0 0 1 3-3Z" fill="#000000" opacity="1" data-original="#000000"></path><path d="M41 36a4.95 4.95 0 0 0 1.1 3.09 4.987 4.987 0 0 0-3.1 1.94 4.987 4.987 0 0 0-3.1-1.94A4.95 4.95 0 0 0 37 36a5 5 0 0 0-10 0 4.95 4.95 0 0 0 1.1 3.09A5.001 5.001 0 0 0 24 44v10a1 1 0 0 0 1 1h28a1 1 0 0 0 1-1V44a5.001 5.001 0 0 0-4.1-4.91A4.95 4.95 0 0 0 51 36a5 5 0 0 0-10 0Zm-9-3a3 3 0 1 1-3 3 3.003 3.003 0 0 1 3-3Zm6 20H26v-9a3.003 3.003 0 0 1 3-3h6a3.003 3.003 0 0 1 3 3Zm8-20a3 3 0 1 1-3 3 3.003 3.003 0 0 1 3-3Zm3 8a3.003 3.003 0 0 1 3 3v9H40v-9a3.003 3.003 0 0 1 3-3Z" fill="#000000" opacity="1" data-original="#000000"></path></g></svg>
//                                     <span>Sites</span>
//                                 </Link>
//                             </li>
//                             {/* <li>
//                                 <Link
//                                     to="tasks.html"
//                                     className="drop-link d-none"
//                                     role="button"
//                                 >
//                                     <svg xmlns="http://www.w3.org/2000/svg" version="1.1"  width="18" height="18" x="0" y="0" viewBox="0 0 48 60" style={{enableBackground:"new 0 0 512 512"}} ><g><path d="M4 60h40a4 4 0 0 0 4-4V8.829a2.984 2.984 0 0 0-.255-1.2c-.008-.021-.021-.038-.031-.059a3 3 0 0 0-.593-.862L41.293.879a3 3 0 0 0-.867-.6c-.018-.008-.033-.02-.052-.027A2.977 2.977 0 0 0 39.172 0H4a4 4 0 0 0-4 4v52a4 4 0 0 0 4 4zM44.586 7H43a2 2 0 0 1-2-2V3.414zM2 4a2 2 0 0 1 2-2h35v3a4 4 0 0 0 4 4h3v47a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z" fill="#000000" opacity="1" data-original="#000000"></path><path d="M9 23h6a3 3 0 0 0 3-3v-5.586l2.707-2.707a1 1 0 0 0-1.414-1.414L17.385 12.2A2.985 2.985 0 0 0 15 11H9a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3zm-1-9a1 1 0 0 1 1-1h6a.994.994 0 0 1 .93.656L13 16.586l-1.293-1.293a1 1 0 0 0-1.414 1.414l2 2a1 1 0 0 0 1.414 0L16 16.414V20a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1zM9 37h6a3 3 0 0 0 3-3v-6a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3zm-1-9a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1zM9 51h6a3 3 0 0 0 3-3v-6a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3zm-1-9a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1zM24 15h17a1 1 0 0 0 0-2H24a1 1 0 0 0 0 2zM24 20h10a1 1 0 0 0 0-2H24a1 1 0 0 0 0 2zM24 29h17a1 1 0 0 0 0-2H24a1 1 0 0 0 0 2zM24 34h10a1 1 0 0 0 0-2H24a1 1 0 0 0 0 2zM24 43h17a1 1 0 0 0 0-2H24a1 1 0 0 0 0 2zM24 48h10a1 1 0 0 0 0-2H24a1 1 0 0 0 0 2z" fill="#000000" opacity="1" data-original="#000000"></path></g></svg>
//                                     <span>Tasks</span>
//                                 </Link>
//                             </li> */}
...
//                                     <li>
//                                         <Link to="" className="drop-link inner" role="button">
...
//                                     </li>
//                                     <li>
//                                         <Link to="javascript:void(0)" className="drop-link inner" role="button">
...
//                             <li className="d-none">
//                                 <Link className="drop-link btn-menu" role="button">
//                                     <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" x="0" y="0" viewBox="0 0 74 74" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><text fill="red" font-family="ArialMT, Arial" font-size="18" transform="translate(31.995 -18.544)" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">4<tspan x="-5.005" y="124" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">14</tspan><tspan x="-5.005" y="248" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">24</tspan><tspan x="-5.005" y="372" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">34</tspan><tspan x="-5.005" y="496" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">44</tspan><tspan x="-5.005" y="620" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">54</tspan><tspan x="-5.005" y="744" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">64</tspan><tspan x="-5.005" y="868" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">74</tspan><tspan x="-5.005" y="992" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">84</tspan><tspan x="-5.005" y="1116" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">94</tspan><tspan x="-10.011" y="1240" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">104</tspan><tspan x="-9.343" y="1364" letter-spacing="-.074em" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">1</tspan><tspan x="-.668" y="1364" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">14</tspan><tspan x="-10.011" y="1488" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">124</tspan><tspan x="-10.011" y="1612" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">134</tspan><tspan x="-10.011" y="1736" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">144</tspan><tspan x="-10.011" y="1860" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">154</tspan><tspan x="-10.011" y="1984" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">164</tspan><tspan x="-10.011" y="2108" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">174</tspan><tspan x="-10.011" y="2232" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">184</tspan><tspan x="-10.011" y="2356" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">194</tspan><tspan x="-10.011" y="2480" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">204</tspan><tspan x="-10.011" y="2604" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">214</tspan><tspan x="-10.011" y="2728" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">224</tspan><tspan x="-10.011" y="2852" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">234</tspan><tspan x="-10.011" y="2976" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">244</tspan><tspan x="-10.011" y="3100" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">254</tspan><tspan x="-10.011" y="3224" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">264</tspan><tspan x="-10.011" y="3348" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">274</tspan><tspan x="-10.011" y="3472" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">284</tspan><tspan x="-10.011" y="3596" svgjs:data="{&quot;leading&quot;:&quot;1.3&quot;}">294</tspan></text><g data-name="2 PT"><path d="M71 22H3a1 1 0 0 1-.908-1.419l6-13A1 1 0 0 1 9 7h56a1 1 0 0 1 .908.581l6 13A1 1 0 0 1 71 22ZM4.563 20h64.874L64.36 9H9.64Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M7.857 34A5.864 5.864 0 0 1 2 28.143V21a1 1 0 0 1 1-1h9.714a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 7.857 34ZM4 22v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M17.571 34a5.864 5.864 0 0 1-5.857-5.857V21a1 1 0 0 1 1-1h9.714a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 17.571 34Zm-3.857-12v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M27.286 34a5.864 5.864 0 0 1-5.857-5.857V21a1 1 0 0 1 1-1h9.714a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 27.286 34Zm-3.857-12v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M37 34a5.864 5.864 0 0 1-5.857-5.857V21a1 1 0 0 1 1-1h9.714a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 37 34Zm-3.857-12v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M46.714 34a5.864 5.864 0 0 1-5.857-5.857V21a1 1 0 0 1 1-1h9.714a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 46.714 34Zm-3.857-12v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M56.429 34a5.864 5.864 0 0 1-5.857-5.857V21a1 1 0 0 1 1-1h9.714a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 56.429 34Zm-3.858-12v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M66.143 34a5.864 5.864 0 0 1-5.857-5.857V21a1 1 0 0 1 1-1H71a1 1 0 0 1 1 1v7.143A5.864 5.864 0 0 1 66.143 34Zm-3.857-12v6.143a3.857 3.857 0 0 0 7.714 0V22Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M68 70H5.91a1 1 0 0 1-1-1V32h2v36H67V32h2v37a1 1 0 0 1-1 1Z" fill="#000000" opacity="1" data-original="#000000" class=""></path><path d="M60 70H43a1 1 0 0 1-1-1V41a1 1 0 0 1 1-1h17a1 1 0 0 1 1 1v28a1 1 0 0 1-1 1Zm-16-2h15V42H44ZM37 61.5H12a1 1 0 0 1-1-1v-20a1 1 0 0 1 1-1h25a1 1 0 0 1 1 1v20a1 1 0 0 1-1 1Zm-24-2h23v-18H13Z" fill="#000000" opacity="1" data-original="#000000" class=""></path></g></g></svg>
//                                     <span>Store</span>
...
//                                 role="button">
//                                     <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="18" x="0" y="0" viewBox="0 0 48 48" style={{ enableBackground: "new 0 0 512 512" }} className=""><g><g data-name="11 - 20"><path d="m43.018 42.784-3.9-3.912a9.015 9.015 0 1 0-4.243 4.242l3.911 3.9a2.994 2.994 0 1 0 4.236-4.233zM26.05 39.95a7 7 0 1 1 9.9 0 7.007 7.007 0 0 1-9.9 0zM41.6 45.6a1 1 0 0 1-1.406 0l-3.581-3.573a8.489 8.489 0 0 0 1.414-1.413L41.6 44.2a.991.991 0 0 1 0 1.406z" fill="#000000" opacity="1" data-original="#000000"></path><path d="M25 44H12a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3h17.38a2.973 2.973 0 0 1 .62.067V10a3 3 0 0 0 3 3h5.923a3 3 0 0 1 .077.651V27a1 1 0 0 0 2 0V13.651a4.975 4.975 0 0 0-1.456-3.527l-6.62-6.651A4.965 4.965 0 0 0 29.38 2H12a5.006 5.006 0 0 0-5 5v34a5.006 5.006 0 0 0 5 5h13a1 1 0 0 0 0-2zm12.594-33H33a1 1 0 0 1-1-1V5.38z" fill="#000000" opacity="1" data-original="#000000"></path><path d="M14 13h11a1 1 0 0 0 0-2H14a1 1 0 0 0 0 2zM34 17H17a1 1 0 0 0 0 2h17a1 1 0 0 0 0-2zM35 23a1 1 0 0 0-1-1H14a1 1 0 0 0 0 2h20a1 1 0 0 0 1-1zM21 28a1 1 0 0 0-1-1h-6a1 1 0 0 0 0 2h6a1 1 0 0 0 1-1zM14 34h4a1 1 0 0 0 0-2h-4a1 1 0 0 0 0 2zM14 39h5a1 1 0 0 0 0-2h-5a1 1 0 0 0 0 2zM31 38a3 3 0 0 1-3-3 1 1 0 0 0-2 0 5.006 5.006 0 0 0 5 5 1 1 0 0 0 0-2z" fill="#000000" opacity="1" data-original="#000000"></path></g></g></svg>
//                                     <span>Reports</span>
//                                 </Link>
//                             </li>
//                         </ul>
...
//                     {/* HRM and Masters  */}
//                     <li>
//                         {!barIconClicked && (<Link className="drop-link btn-menu" role="button" onClick={toggleHRM}>
//                             <span className="menu-title border-0 p-0 m-0"> HRM </span>
//                             <svg
//                                 className={HRM ? "chevron ms-auto dropdown rotate" : "chevron ms-auto dropdown"}
...
//                         </Link>
//                         )}
//                         <ul className="sub-menu" style={{ display: HRM ? "block" : "none" && barIconClicked ? "block" : 'none' }}>
//                             <li>
//                                 <Link
//                                     to={RoutesLink?.attendance_route}
//                                     onClick={() => toggleIsActive('attendance')}
//                                     className={isActive === 'attendance' ? 'drop-link active' : 'drop-link'}
//                                     role="button"
//                                 >
//                                     <svg
//                                         xmlns="http://www.w3.org/2000/svg"
...
//                                     className={isActive === 'leave' ? "drop-link active" : "drop-link"}
//                                     role="button">
//                                     <svg
//                                         xmlns="http://www.w3.org/2000/svg"
//                                         version="1.1"
...
//                                     onClick={() => toggleIsActive('holidays')}
//                                     className={isActive === 'holidays' ? "drop-link active" : "drop-link"}
//                                     role="button">
//                                     <svg
//                                         xmlns="http://www.w3.org/2000/svg"
//                                         version="1.1"
...
//                             <li>
//                                 {!barIconClicked && (<Link className="drop-link btn-menu" role="button" onClick={toggleMAsters}>
//                                     <span className="menu-title border-0 p-0 m-0"> Masters </span>
//                                     <svg
//                                         className={Masters ? "chevron ms-auto dropdown rotate" : "chevron ms-auto dropdown "}
//                                         xmlns="http://www.w3.org/2000/svg"
//                                         width="20"
//                                         height="20"
//                                         viewBox="0 0 20 20"
...
//                                 </Link>
//                                 )}
//                                 <ul className="sub-menu" style={{ display: Masters ? "block" : "none" && barIconClicked ? "block" : 'none' }}>
//                                     <li>
//                                         <Link
//                                             to={RoutesLink?.department_route}
//                                             className="drop-link"
//                                             role="button"
//                                         >
//                                             <svg
...
//                                     <li>
//                                         <Link
//                                             to="shift-time-configuration.html"
//                                             className="drop-link"
//                                             role="button"
//                                         >
//                                             <svg
...
//                                     </li>
//                                     <li>
//                                         <Link to="overtime.html" class="drop-link" role="button">
//                                             <svg
//                                                 xmlns="http://www.w3.org/2000/svg"
//                                                 version="1.1"
...
//                         <Link className={barIconClicked ? "navbar-brand p-0 brand-change" : "navbar-brand p-0"} id="brand" to="">
//                             <img
//                                 className="main-logo"
...
//                         </Link>
//                         <div
//                             className="collapse navbar-collapse justify-content-between align-items-stretch ms-5 border-start ps-5"
//                         >
//                             <button
//                                 onClick={handleToggle}
//                                 className="btn btn-toggle border-0"
//                                 id="toggleButton"
//                                 type="button"
//                             >
...
//                             <div
//                                 className="header-nav d-flex align-items-stretch justify-content-end w-100"
//                             >
...
//                                             <button
//                                                 className={!dropDown ? "btn dropdown-toggle show" : "btn dropdown-toggle"}
//                                                 type="button"
...
//                                             </button>
//                                             <ul className={!dropDown ? "dropdown-menu shadow" : "dropdown-menu shadow show"} data-bs-popper="static">
//                                                 <li>
