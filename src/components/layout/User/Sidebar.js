                                ...
                                <ul className="sidebar-vertical">
                                    ...
                                    <li>
                                        ...
                                        <ul className="sub-menu inner" style={{ display: attendance ? "block" : 'none' }}>
                                            ...
                                            <li>
                                                <Link
                                                    to={RoutesLink?.user_outdoor_attendance_route}
                                                    onClick={() => toggleIsActive('outdoor')}
                                                    className={isActive === 'outdoor' ? "drop-link inner active " : "drop-link inner " }
                                                    role="button"
                                                >
                                    ...
                                    <li>
                                        ...
                                        <ul className="sub-menu inner" style={{ display: regularization ? "block" : 'none' }}>
                                            <li>
                                                <Link to={RoutesLink?.user_attendance_regularization}
                                            ...
                                            <li>
                                                <Link to={RoutesLink?.user_attendance_regularization_request}
                                    ...
                                    <li>
                                        ...
                                        <ul className="sub-menu inner" style={{ display: reimbursement ? "block" : 'none' }}>
                                            <li>
                                                <Link to={RoutesLink?.user_reimbursement}
                                            ...
                                            <li>
                                                <Link to={RoutesLink?.user_reimbursement_request}
                                    ...
                                    <li>
                                        <Link to={RoutesLink?.user_holiday_route}
                                    ...
                                    <li>
                                        <Link to={RoutesLink?.user_payslip_route}
