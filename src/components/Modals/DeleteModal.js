...
export default function DeleteModal({deleteModal , toggleDeleteModal , modalTittle , modalContent   }) {
    return (
        <>
                ...
                <div className="modal-dialog modal-dialog-centered dlt-modal">
                    <div className="modal-content shadow-lg">
                        <div className="modal-body p-5 text-center">
                            ...
                            <h4 className="fs-2">Delete {modalTittle}</h4>
                            <p className="fs-5 mb-5">Would you like to Delete this {modalContent}?</p>
