        ...
        <>   
            ...
            <div className="sorted">
                ...
                <div className="dropdown">
                    <button onClick={handleSorting} className="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        30
                        <span>
                    ...
                    <ul className={sorting ? "dropdown-menu shadow-lg show" : "dropdown-menu shadow-lg "} style={{ display: sorting ? 'block' : 'none' }}>
